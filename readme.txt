...
. If the MCR is not installed, run MCRInstaller, located in:
  ...
  <mcr_root>*/toolbox/compiler/deploy/maci/MCRInstaller.dmg
...
================================
-audiotest34 
-run_audiotest34.sh (shell script run to temporarily set environment variables and 
                     execute the application)
   -to run the shell script, type
   
       ./run_audiotest34.sh <mcr_directory> <argument_list>
    ...
    MATLAB is installed on the machine ( MCRROOT="/Applications/MATLAB_R2010a.app/). <argument_list> is all the 
    arguments you want to pass to your application. For example, 

    If you have version 7.13 of MCR installed in 
    /mathworks/home/application/R2010a/v713, run the shell script as:
    
       ./run_audiotest34.sh /mathworks/home/application/R2010a/v713
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_audiotest34.sh /mathworks/devel/application/matlab
-MCRInstaller.dmg 
    ...
    Mac                     DYLD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        NOTE: <mcr_root> is the directory where MCR is installed
              on the target machine.  mcr_root="/Applications/MATLAB/"
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_audiotest34.sh 
