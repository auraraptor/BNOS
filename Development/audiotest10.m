...
if isempty(subject_num)
    subject_num = 'not entered';
end

%press_space(); % Press space bar to begin
%clf; % clears menu from screen
CSV(size(CSV,1)+1,1) = ( subject_num );
